...
class SAC(object):
    def __init__(self, num_inputs, action_space,gamma=0.99,tau=0.01,alpha=0.2,lr=0.0003,hidden_size = 256,target_update_interval = 1):
    ...
    def load_checkpoint(self, ckpt_path):
        ...
        if ckpt_path is not None:
            ...
            raise Exception("Enter a valid checkpoint path")
